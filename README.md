...
After the workflow completes, and you've had a second to read through the log file in it's entirety you should be good to go! You'll see a bunch of messages about missing scripts and it's intent to download them into your GitHub repository, if that's all you see you're golden and can move on to the next step!
